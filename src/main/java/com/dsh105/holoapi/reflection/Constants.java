...
public enum Constants {
    ...
    PACKET_ATTACHENTITY_FIELD_LEASHED(new String[]{"a"}, "field_111007_a", "field_149408_a"),
    PACKET_ATTACHENTITY_FIELD_ENTITYID(new String[]{"b"}, "field_111006_b", "field_149406_b"),
    PACKET_ATTACHENTITY_FIELD_VEHICLEID(new String[]{"c"}, "field_73296_b", "field_149407_c"),

    PACKET_ENTITYDESTROY_FIELD_IDS(new String[]{"a"}, "field_73368_a", "field_149100_a"),

    PACKET_ENTITYTELEPORT_FIELD_ID(new String[]{"a"}, "field_73319_a", "field_149458_a"),
    PACKET_ENTITYTELEPORT_FIELD_X(new String[]{"b"}, "field_73317_b", "field_149456_b"),
    PACKET_ENTITYTELEPORT_FIELD_Y(new String[]{"c"}, "field_73318_c", "field_149457_c"),
    PACKET_ENTITYTELEPORT_FIELD_Z(new String[]{"d"}, "field_73315_d", "field_149454_d"),
    PACKET_ENTITYTELEPORT_FIELD_YAW(new String[]{"e"}, "field_73316_e", "field_149455_e"),
    PACKET_ENTITYTELEPORT_FIELD_PITCH(new String[]{"f"}, "field_73314_f", "field_149453_f"),

    PACKET_SPAWNENTITY_FIELD_ID(new String[]{"a"}, "field_73526_a", "field_149018_a"),
    PACKET_SPAWNENTITY_FIELD_X(new String[]{"b"}, "field_73524_b", "field_149016_b"),
    PACKET_SPAWNENTITY_FIELD_Y(new String[]{"c"}, "field_73525_c", "field_149017_c"),
    PACKET_SPAWNENTITY_FIELD_Z(new String[]{"d"}, "field_73522_d", "field_149014_d"),
    PACKET_SPAWNENTITY_FIELD_MOTX(new String[]{"e"}, "field_73523_e", "field_149015_e"),
    PACKET_SPAWNENTITY_FIELD_MOTY(new String[]{"f"}, "field_73520_f", "field_149012_f"),
    PACKET_SPAWNENTITY_FIELD_MOTZ(new String[]{"g"}, "field_73521_g", "field_149013_g"),
    PACKET_SPAWNENTITY_FIELD_YAW(new String[]{"h"}, "field_92077_h", "field_149021_h"),
    PACKET_SPAWNENTITY_FIELD_PITCH(new String[]{"i"}, "field_92078_i", "field_149022_i"),
    PACKET_SPAWNENTITY_FIELD_TYPE(new String[]{"j"}, "field_73527_h", "field_149019_j"),
    PACKET_SPAWNENTITY_FIELD_DATA(new String[]{"k"}, "field_73528_i", "field_149020_k"),

    PACKET_SPAWNENTITYLIVING_FIELD_ID(new String[]{"a"}, "field_73496_a", "field_149042_a"),
    PACKET_SPAWNENTITYLIVING_FIELD_TYPE(new String[]{"b"}, "field_73494_b", "field_149040_b"),
    PACKET_SPAWNENTITYLIVING_FIELD_X(new String[]{"c"}, "field_73495_c", "field_149041_c"),
    PACKET_SPAWNENTITYLIVING_FIELD_Y(new String[]{"d"}, "field_73492_d", "field_149038_d"),
    PACKET_SPAWNENTITYLIVING_FIELD_Z(new String[]{"e"}, "field_73493_e", "field_149039_e"),
    PACKET_SPAWNENTITYLIVING_FIELD_MOTX(new String[]{"f"}, "field_73490_f", "field_149036_f"),
    PACKET_SPAWNENTITYLIVING_FIELD_MOTY(new String[]{"g"}, "field_73491_g", "field_149037_g"),
    PACKET_SPAWNENTITYLIVING_FIELD_MOTZ(new String[]{"h"}, "field_73499_h", "field_149047_h"),
    PACKET_SPAWNENTITYLIVING_FIELD_YAW(new String[]{"i"}, "field_73500_i", "field_149048_i"),
    PACKET_SPAWNENTITYLIVING_FIELD_HEADPITCH(new String[]{"j"}, "field_73497_j", "field_149045_j"),
    PACKET_SPAWNENTITYLIVING_FIELD_HEADYAW(new String[]{"k"}, "field_73498_k", "field_149046_k"),
    PACKET_SPAWNENTITYLIVING_FIELD_META(new String[]{"t", "l"}, "field_73502_s", "field_149043_l"),
