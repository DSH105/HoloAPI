...
public interface HoloManager {
    ...
    /**
     * Creates a simple hologram. Simple holograms are automatically removed after a certain period of time, are not
     * saved to file and can only include text content.
     *
