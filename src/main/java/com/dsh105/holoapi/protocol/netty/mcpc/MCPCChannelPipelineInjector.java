...
/**
 * This is exactly the same as the ChannelPipelineInjector, except this version uses non-verisonized netty imports
 * in order to work with MCPC+
 */
public class MCPCChannelPipelineInjector extends ChannelDuplexHandler implements PlayerInjector {
    ...
    public MCPCChannelPipelineInjector(Player player, InjectionManager manager) {
            ...
            if (injected) {
                ...
                getChannel().eventLoop().submit(new Callable<Object>() {
                    ...
                    public Object call() throws Exception {
                        getChannel().pipeline().remove(MCPCChannelPipelineInjector.this);
                        return null;
                    }
